...
from BA_Optimization.covisibility import GraphKeyFrame, GraphMapPoint, GraphMeasurement
...
class RGBDFrame(Frame):
    def __init__(self, idx, pose, feature, depth, cam, pose_covariance=np.identity(6)):

        super().__init__(idx, pose, feature, cam, pose_covariance)
        self.rgb = Frame(idx, pose, feature, cam, pose_covariance)
        self.depth = depth
